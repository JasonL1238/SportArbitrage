...
SETTLEMENT: dict[str, SettlementRegime] = {
    ...
    "bet365": SettlementRegime.VOID_AND_REFUND,
    ...
    "an_parx": SettlementRegime.VOID_AND_REFUND,
    "an_unibet": SettlementRegime.VOID_AND_REFUND,
    "an_thescore": SettlementRegime.VOID_AND_REFUND,
    "vi_draftkings": SettlementRegime.VOID_AND_REFUND,
    "vi_caesars": SettlementRegime.VOID_AND_REFUND,
    "vi_hardrock": SettlementRegime.VOID_AND_REFUND,
    "vi_fanatics": SettlementRegime.VOID_AND_REFUND,
    "vi_bet365": SettlementRegime.VOID_AND_REFUND,
    "vi_betmgm": SettlementRegime.VOID_AND_REFUND,
    "vi_fanduel": SettlementRegime.VOID_AND_REFUND,
    "vi_betrivers": SettlementRegime.VOID_AND_REFUND,
    "vsin_circa": SettlementRegime.VOID_AND_REFUND,
