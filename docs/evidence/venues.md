...
| `betparx_kambi` | betPARX Pennsylvania | sportsbook | none (in the price) | 21 | Kambi offering API, operator `parxuspa` (market `US-PA`); `parxusnj` in NJ. Registered 2026-08-23 from a Philadelphia egress |
